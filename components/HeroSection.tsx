  ...
  return (
    <section className="mb-5">
      ...
      <div className="text-foreground">
        <p className="mt-4">{t("hero.description1")}</p>
      ...
      <div className="flex space-x-4 mb-2 mt-4">
        <div className="text-muted-foreground hover:text-foreground transition-colors flex">
          <Link
            target="_blank"
        ...
        <div className="text-muted-foreground hover:text-foreground transition-colors flex">
          ...
          >
            <svg
              viewBox="0 0 24 24"
              className="group-hover:fill-primary h-6 w-6 flex-none fill-muted-foreground hover:fill-foreground transition"
            >
