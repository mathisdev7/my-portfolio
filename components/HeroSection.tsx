  ...
  return (
    <section className="mb-8">
      ...
      <div className="flex space-x-4 mb-2 mt-4">
        <div className="text-secondary hover:text-foreground transition-colors flex">
          <Link
            target="_blank"
        ...
        <div className="text-secondary hover:text-foreground transition-colors flex">
          ...
          >
            <svg
              viewBox="0 0 24 24"
              className="group-hover:fill-primary h-6 w-6 flex-none fill-secondary hover:fill-foreground transition"
            >
